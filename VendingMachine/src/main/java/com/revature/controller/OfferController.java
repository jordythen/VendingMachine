...
public class OfferController {
	...
	@GetMapping(path="/otherusersoffers")
	public ResponseEntity< List<Offer> > getOtherUsersOffersForMySnacks(HttpSession session){
		User u=(User) session.getAttribute("user");
		 List<Offer> offerList=offerServ.getOtherUsersOffersForMySnacks(u);
...
//	
	...
	public ResponseEntity<Offer> addOffer(@RequestBody Offer offer, HttpSession session){
		...
		offer.setId(offerServ.add(offer));
		//user update here================================================
		User u=(User) session.getAttribute("user");
		List<Offer> uoffers=u.getPendingOffers();
		uoffers.add(offer);
		u.setPendingOffers(uoffers);
		userv.update(u);
		//---------------------------------------
